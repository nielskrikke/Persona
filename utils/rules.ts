...
import { CharacterClass, AbilityScores, AbilityName, SpellDetail } from '@/types';
...
export const getSpellsKnownCount = (characterClass: CharacterClass, abilities: AbilityScores): { cantrips: number; spells: number } => {
    ...
    const abilityScore = (definition.spellcasting?.spellcasting_ability.index || 'int') as AbilityName;
